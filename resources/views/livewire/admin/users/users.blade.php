<div class="content-wrapper">
    ...
    <!-- UserRoles  Modal -->
    <div wire:ignore.self class="modal fade" id="UserRoles" tabindex="-1" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">User Roles/Permissions</h5>
                    <button type="button" wire:click='refreshID' class="btn-close" data-bs-dismiss="modal"
