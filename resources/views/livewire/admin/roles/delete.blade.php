<div>
    <p data-ar="هل أنت متأكد أنك تريد حذف هذا المستخدم؟ لا يمكن التراجع عن هذا الإجراء."
        data-en="Are you sure you want to delete  this Role? This action cannot be undone.">
        Are you sure you want to delete this <b> Role </b>? This action cannot be undone. </p>
    ...
    <div class="modal-footer">
        ...
        <button type="button" class="btn btn-danger" wire:click="deleteRole" data-ar="حذف"
